...
try {
  ...
  const census2020Population: Record<string, number> = {
    'ROGERS PARK': 54991, 'WEST RIDGE': 75201, 'UPTOWN': 58057, 'LINCOLN SQUARE': 39493,
    'NORTH CENTER': 31867, 'LAKE VIEW': 103050, 'LINCOLN PARK': 70799, 'NEAR NORTH SIDE': 105481,
    'EDISON PARK': 11128, 'NORWOOD PARK': 38711, 'JEFFERSON PARK': 25448, 'FOREST GLEN': 18298,
    'NORTH PARK': 17931, 'ALBANY PARK': 51542, 'PORTAGE PARK': 64124, 'IRVING PARK': 53359,
    'DUNNING': 42164, 'MONTCLARE': 12797, 'BELMONT CRAGIN': 78743, 'HERMOSA': 24062,
    'AVONDALE': 37619, 'LOGAN SQUARE': 71665, 'HUMBOLDT PARK': 54165, 'WEST TOWN': 87435,
    'AUSTIN': 98514, 'WEST GARFIELD PARK': 17433, 'EAST GARFIELD PARK': 19992, 'NEAR WEST SIDE': 54881,
    'NORTH LAWNDALE': 34794, 'SOUTH LAWNDALE': 79288, 'LOWER WEST SIDE': 33751, 'LOOP': 42298,
    'NEAR SOUTH SIDE': 28795, 'ARMOUR SQUARE': 13391, 'DOUGLAS': 18238, 'OAKLAND': 6799,
    'FULLER PARK': 2876, 'GRAND BOULEVARD': 21390, 'KENWOOD': 17841, 'WASHINGTON PARK': 11717,
    'HYDE PARK': 25681, 'WOODLAWN': 25983, 'SOUTH SHORE': 47816, 'CHATHAM': 30760,
    'AVALON PARK': 9635, 'SOUTH CHICAGO': 31198, 'BURNSIDE': 2916, 'CALUMET HEIGHTS': 13022,
    'ROSELAND': 38816, 'PULLMAN': 7325, 'SOUTH DEERING': 13731, 'EAST SIDE': 22158,
    'WEST PULLMAN': 29193, 'RIVERDALE': 6482, 'HEGEWISCH': 9423, 'GARFIELD RIDGE': 34513,
    'ARCHER HEIGHTS': 14196, 'BRIGHTON PARK': 45368, 'MCKINLEY PARK': 15612, 'BRIDGEPORT': 33702,
    'NEW CITY': 44377, 'WEST ELSDON': 18902, 'GAGE PARK': 39894, 'CLEARING': 25629,
    'WEST LAWN': 29032, 'CHICAGO LAWN': 54991, 'WEST ENGLEWOOD': 30654, 'ENGLEWOOD': 24369,
    'GREATER GRAND CROSSING': 31471, 'ASHBURN': 41081, 'AUBURN GRESHAM': 48743, 'BEVERLY': 20027,
    'WASHINGTON HEIGHTS': 27086, 'MOUNT GREENWOOD': 18990, 'MORGAN PARK': 22544, 'OHARE': 12756,
    'EDGEWATER': 56521
  };
  
  // Health disparity factors - South/West higher rates, North lower rates
  const healthFactors: Record<string, number> = {
    // South Side - Higher rates
    ...
    'ROGERS PARK': 0.8, 'WEST RIDGE': 0.8, 'UPTOWN': 0.8, 'ALBANY PARK': 0.8, 'EDGEWATER': 0.8,
    // Central/Mixed
    'LOOP': 0.7, 'NEAR SOUTH SIDE': 0.9, 'NEAR WEST SIDE': 0.8, 'WEST TOWN': 0.8,
    'ARMOUR SQUARE': 1.0, 'KENWOOD': 0.9, 'HYDE PARK': 0.6, 'BRIDGEPORT': 1.0,
    'BEVERLY': 0.7, 'WASHINGTON HEIGHTS': 1.0, 'MOUNT GREENWOOD': 0.7, 'MORGAN PARK': 0.8, 'OHARE': 0.9
  };
    ...
    features: rawData.features.map((feature: any) => {
      ...
      return {
        ...
        properties: {
          ...
          diseases: {
            diabetes: {
              id: 'diabetes', name: 'Diabetes', icdCodes: 'E10-E14',
            ...
            hypertension: {
              id: 'hypertension', name: 'Hypertension', icdCodes: 'I10-I15',
            ...
            heart: {
              id: 'heart', name: 'Heart Disease', icdCodes: 'I20-I25',
            ...
            copd: {
              id: 'copd', name: 'COPD', icdCodes: 'J40-J44',
            ...
            asthma: {
              id: 'asthma', name: 'Asthma', icdCodes: 'J45',
            ...
            stroke: {
              id: 'stroke', name: 'Stroke', icdCodes: 'I60-I69',
              count: Math.floor(actualPopulation * (0.02 * healthFactor + Math.random() * 0.01)),
              rate: parseFloat(((0.02 * healthFactor + Math.random() * 0.01) * 1000).toFixed(1))
            },
            ckd: {
              id: 'ckd', name: 'Chronic Kidney Disease', icdCodes: 'N18',
            ...
            depression: {
              id: 'depression', name: 'Depression', icdCodes: 'F32-F33',
            ...
            anxiety: {
              id: 'anxiety', name: 'Anxiety Disorders', icdCodes: 'F40-F41',
            ...
            obesity: {
              id: 'obesity', name: 'Obesity', icdCodes: 'E66',
            ...
            cancer: {
              id: 'cancer', name: 'Cancer', icdCodes: 'C00-C97',
            ...
            arthritis: {
              id: 'arthritis', name: 'Arthritis', icdCodes: 'M05-M06, M15-M19',
            ...
            osteoporosis: {
              id: 'osteoporosis', name: 'Osteoporosis', icdCodes: 'M80-M81',
            ...
            liver: {
              id: 'liver', name: 'Liver Disease', icdCodes: 'K70-K77',
            ...
            substance: {
              id: 'substance', name: 'Substance Use Disorder', icdCodes: 'F10-F19',
  ...
  console.log(`Loaded ${chicagoCommunitiesData.features.length} Chicago community areas with realistic health patterns`);
} catch (error) {
...
function generateCensusTractData() {
  const censusTracts = [];
  const chicagoBounds = { latMin: 41.64, latMax: 42.02, lngMin: -87.94, lngMax: -87.52 };
  
  for (let i = 0; i < 2088; i++) {
    const tractCode = `17031${(8000 + i).toString()}`;
    const tractId = `${tractCode}00`;
    ...
    censusTracts.push({
      ...
      type: 'Feature',
      properties: {
        id: tractId, name: `Census Tract ${tractCode.slice(-4)}`, geoid: tractId,
        population: population, density: Math.floor(population / areaKm2 * 2.59),
        diseases: {
          diabetes: {
            id: 'diabetes', name: 'Diabetes', icdCodes: 'E10-E14',
  ...
  return { type: 'FeatureCollection', features: censusTracts };
}

chicagoCensusTractsData = generateCensusTractData();
